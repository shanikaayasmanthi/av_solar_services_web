...
const NewBatteryDetails = ({ show, onClose, projectId }) => {
  ...
  const addNewEmptyRow = () => {
    const newRow = {
      id: `new-${Date.now()}-${batteryRows.length}`,
      brand: "",
      model_code: "",
      serial_no: "",
      capacity: "",
    };
    setBatteryRows([...batteryRows, newRow]);
    setError("");
  };

  const handleRowChange = (index, field, value) => {
    const updatedRows = [...batteryRows];
    updatedRows[index] = { ...updatedRows[index], [field]: value };
    setBatteryRows(updatedRows);
    setError("");
  };
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold">Add New Battery Details</h2>
          <button 
            onClick={onClose}
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="p-2 border">Battery Model Code</th>
                <th className="p-2 border">Battery Serial No</th>
                <th className="p-2 border">Battery Capacity (kWh)</th>
        ...
        <div className="flex flex-wrap gap-3 justify-between">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              disabled={isSubmitting || batteryRows.length === 0}
              className={`px-4 py-2 rounded ${
                isSubmitting || batteryRows.length === 0
...
export default NewBatteryDetails;