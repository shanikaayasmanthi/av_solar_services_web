...
export default function OngridProjectDataCard({project,onGrid}) {
  ...
  return (
    <div>
      ...
      <div class="card-content">
        ...
        <div class="flex flex-row flex-wrap">
          <div class="flex flex-col w-1/2">
            <label class="block text-sm mt-2.5 mb-1.5">Harmonic meter</label>
            <input
              disabled
        ...
        <textarea
          disabled
          value={`${project?.remarks||''} ${onGrid.remarks||''}No special notes`}
          class="w-[90%] p-2 rounded-lg border border-gray-300 bg-gray-200"
        />
      ...
      {showWifiModal && (
        <WifiDetailsModel username={onGrid.wifi_username} password={onGrid.wifi_password} show={showWifiModal} onClose={()=>setShowWifiModal(false)}/>
      )}
    </div>
  )
}
